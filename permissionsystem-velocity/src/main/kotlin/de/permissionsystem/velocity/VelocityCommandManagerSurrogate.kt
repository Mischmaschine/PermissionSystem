...
class VelocityCommandManagerSurrogate(proxyServer: ProxyServer, plugin: Any) :
    VelocityCommandManager(proxyServer, plugin) {
    ...
    init {
        this.locales.addMessages(Locale.ENGLISH, buildMap<MessageKeyProvider, String> {
            ...
            put(MessageKeys.NOT_ALLOWED_ON_CONSOLE, "Error: This command is not allowed on the console.")
